...
train_pipeline = [
    ...
    dict(type='PASTA', alpha=6.0, k=2, beta=0.25),
...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(type='PASTA', alpha=6.0, k=2, beta=0.25),
            dict(
                type='Resize', img_scale=(1914, 1052), ratio_range=(0.5, 2.0)),
            dict(type='RandomCrop', crop_size=(512, 1024), cat_max_ratio=0.75),
            dict(type='RandomFlip', prob=0.5),
            dict(type='PhotoMetricDistortion'),
            dict(
...
log_level = 'INFO'
load_from = None
resume_from = '/coc/scratch/prithvi/dg_for_da/segmentation_dg/deeplabv3plus_r50-d8_512x1024_40k_GTAV_pasta__a6k2b025_bef_resize_pd/latest.pth'
workflow = [('train', 1)]
